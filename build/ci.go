...
import (
	...
	"github.com/RealMagaCoin/Maga/crypto/signify"
	"github.com/RealMagaCoin/Maga/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/RealMagaCoin/Maga/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/RealMagaCoin/Maga/internal/version.gitDate="+env.Date)
	}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/RealMagaCoin/Maga/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/RealMagaCoin/Maga/mobile")
