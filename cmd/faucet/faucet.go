...
import (
	...
	"github.com/RealMagaCoin/Maga/cmd/utils"
	...
	"github.com/RealMagaCoin/Maga/ethclient"
	"github.com/RealMagaCoin/Maga/ethstats"
	"github.com/RealMagaCoin/Maga/internal/version"
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/RealMagaCoin/Maga/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
